    ...
    if (localStorage.list_data && localStorage.id_data) {
        ...
        if (list_data.length > 0) {
            ...
            data_app += '<thead>' +
                ...
                '<th>Hapus Riwayat Pembelian</th>' +
                '<th>Lihat Struk Pembelian</th>' +
            ...
            data_app = "Menu Pembelian Tidak Ada";
        }
